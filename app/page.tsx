      ...
      <section className="py-16 px-4 text-center" style={{ background: '#84CC4A' }}>
        ...
        <div className="flex flex-wrap justify-center gap-4">
          <a
            ...
            className="px-8 py-3 rounded-full font-bold text-gray-900 text-sm shadow-lg hover:scale-105 transition-all duration-300 flex items-center gap-2"
            style={{ background: 'white' }}
          >
            <svg className="w-4 h-4 flex-shrink-0 text-gray-900" fill="none" stroke="currentColor" strokeWidth={2} viewBox="0 0 24 24">
