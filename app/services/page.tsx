...
const SERVICES = [
  ...
  },
  {
    ...
    price: '₹749',
    original: '₹1,100',
    tagline: 'Eliminate flies and prevent disease-spreading infestations at source.',
    benefits: ['Residual spray targets resting & breeding sites', 'Fly bait & glue board traps installed', 'Covers kitchens, drains & waste areas', 'Safe for food-handling environments'],
    img: '/image 10th.png',
    pastel: '#f0fff4',
    accent: '#16a34a',
    badge: null,
    ...
    <>
      ...
      <section className="relative py-20 px-4 text-center overflow-hidden" style={{ background: '#84CC4A' }}>
        <div className="absolute inset-0">
          <Image src="/ChatGPT Image Apr 29, 2026, 03_25_10 PM.png" alt="bg" fill className="object-cover object-center opacity-20" unoptimized />
        </div>
      ...
      <section className="py-14 px-4 text-center" style={{ background: '#84CC4A' }}>
        ...
        <div className="flex flex-wrap justify-center gap-4">
          ...
          <a href="https://wa.me/919644594899" target="_blank" rel="noopener noreferrer"
            className="bg-white text-gray-900 font-bold px-7 py-3 rounded-full border-2 border-gray-900 hover:bg-gray-900 hover:text-white transition-all flex items-center gap-2">
