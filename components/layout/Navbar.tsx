      ...
      <div className="text-white py-2 px-4 hidden md:block" style={{ background: '#1A6B35' }}>
        <div className="max-w-7xl mx-auto flex items-center justify-between text-xs">
          <div className="flex items-center gap-6">
            <a href="tel:918376090909" className="flex items-center gap-2 hover:text-yellow-300 transition-colors">
              <span>📞</span>
              <span className="font-semibold">+91 8376090909</span>
            </a>
          ...
          <div className="flex items-center gap-3 text-xs">
            <span style={{ color: '#84CC4A' }} className="font-medium">Residential</span>
            <span className="text-white/40">|</span>
            <span style={{ color: '#84CC4A' }} className="font-medium">Commercial</span>
          </div>
        </div>
      </div>
          ...
          <div className="flex items-center justify-between h-20">
            ...
            <Link href="/" className="flex items-center gap-3">
              ...
              <div className="flex flex-col leading-tight">
                <span className="text-base font-extrabold text-gray-900">Pari Pest Control India</span>
                <span className="text-xs font-bold" style={{ color: '#2d8a4e' }}>PPCI PVT. LTD.</span>
              </div>
            </Link>
